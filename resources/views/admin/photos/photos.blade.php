                                    ...
                                    <table id="photos" class="display" style="min-width: 845px">
                                        ...
                                        @foreach($photos as $photo)                       
                                            <tr>
                                                <td>{{$photo -> id}}</td>
                                                <td>{{$photo -> name}}</td>
                                                <td><img src="{{asset('/admin/images')}}/paintingImages/{{$photo -> name}} " width="100px" height="100px" title="painting image"></td>
                                                <td>{{$photo -> status ? "Main-Image" : "Sub-Image"}}</td>
                                                <td>
                                                    {{$photo -> paintingName}} - {{$photo -> paintingId}}
                                                </td>
                                                <td>
                                                    <a href="{{url('/admin/photos/editPhotos/'.$photo -> id . '/' . $photo -> painting_id)}}" class="btn btn-primary">Edit</a>                                                 
