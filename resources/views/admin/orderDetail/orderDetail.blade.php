                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- <div class ="btn btn-primary" style=" margin-right: 960px; margin-left: 20px; ">
                                <a href="{{url('/admin/order/addOrders')}}">Create Order</a>
                            </div> -->
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        @foreach($orderDetails as $orderDetail)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{asset('/admin/images')}}/paintingImages/{{$orderDetail -> photoName}} " width="100px" height="100px" title="painting image">
                                                </td>
                                                <td>{{$orderDetail -> price}}</td>
                                                <td>{{$orderDetail -> quantity}}</td>
                                                <!-- <td>
                                                    <a href="{{url('/admin/orderDetail/deleteOrderDetail/'.$orderDetail -> id)}}" class="btn btn-danger"
