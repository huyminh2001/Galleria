                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class ="btn btn-primary" style=" margin-right: 960px; margin-left: 20px; ">
                                <a href="{{url('/admin/artist/addArtist')}}">Create Artist</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        @foreach($artists as $artist)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{url('/admin/artist/editArtist/'.$artist -> id)}}" class="btn btn-primary">Edit</a>
                                                    <!-- <a href="{{url('/admin/artist/deleteArtist/'.$artist -> id)}}" class="btn btn-danger"
