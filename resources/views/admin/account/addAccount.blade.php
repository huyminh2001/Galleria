                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form method='get' action="{{url('/admin/account/addAccountProcess')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email" class="form-control" name="email" placeholder="hello@example.com" required>
                                        </div>
                                        <div class="form-group">
                                            @if($errors-> has('email'))
                                                 <ul>                                                   
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="submit" name="add-Account" class="btn btn-primary btn-block">Save</button>
    ...
    ***********************************-->
    ...
    <script>
        ...
        onSelect: function( date ) {
            $(this).val(date);  // Ensure a value is set on selection
        }
        });
    </script>
    ...
    <script>
        ...
        const textInputNoSpace = document.getElementById('username');
        textInputNoSpace.addEventListener('keypress', function(event) {
            const char = String.fromCharCode(event.charCode);
            if (char ===' ') {
            event.preventDefault();
            }
