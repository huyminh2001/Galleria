                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- <div class ="btn btn-primary" style=" margin-right: 960px; margin-left: 20px; ">
                                <a href="{{url('/admin/review/addPhotoGallery')}}">Upload Photos</a>
                            </div> -->
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="reviews" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>Account Name</th>
                                        ...
                                        @foreach($reviews as $review)                       
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{$review -> paintingName}} - {{$review -> paintingId}}
                                                ...
                                                <td>{{DateTime::createFromFormat('Y-m-d', $review -> created_at) -> format('d/m/Y')}}</td>
                                                <td>                                                                                       
                                                    <a href="{{url('/admin/review/deleteReview/'.$review -> id)}}" class="btn btn-danger"
