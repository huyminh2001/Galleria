                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gallery Subject</h4>
                            </div>
                            <div class ="btn btn-primary" style=" margin-right: 960px; margin-left: 20px; ">
                                <a href="{{url('/admin/gallery/addGallerySubject')}}">Create Subject</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        @foreach($galleries as $gallery)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{url('/admin/gallery/editGallerySubject/'.$gallery -> id)}}" class="btn btn-primary">Edit</a>
                                                    <a href="{{url('/admin/gallery/deleteGallerySubject/'.$gallery -> id)}}" class="btn btn-danger"
