...
<body class="h-100">
                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <h4 class="text-center mb-4">Edit painting</h4>
                                    @if($painting)
                                    <form method='get' action="{{url('/admin/painting/editPaintingProcess/' . $painting -> id)}}" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label><strong>Painting Name</strong></label>
                                            <input type="text" class="form-control" placeholder="Painting name" id="name" name="name" 
                                            value="{{$painting -> name}}">
                                        </div>
                                        <div class="form-group">
                                            @if($errors-> has('name'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{$painting -> height}}"required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  name="unique">
                                                ...
                                                <option value="0" {{$painting -> unique == 0 ? 'selected': ''}}>Common</option>
                                                <option value="1" {{$painting -> unique == 1 ? 'selected': ''}}>Exclusive</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" class="form-control" name="description"  id="description" required
                                            value="{{$painting -> description}}">{{$painting -> description}}</textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  name="status" required>
                                                <option value="" disabled selected> Select an Attribute</option>
                                                <option value="0" {{$painting -> status == 0 ? 'selected': ''}}>Hide</option>
                                                <option value="1" {{$painting -> status == 1 ? 'selected': ''}}>Show</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  name="artist_id" required>
                                                ...
                                                @foreach($data['artists'] as $artist)
                                                    ...
                                                    {{$painting -> artist_id == $artist -> id ? 'selected':''}}>{{$artist -> name}} - {{$artist -> id}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  name="painting_style_category_id" required>
                                                <option value="" disabled selected> Select a Style</option>
                                                @foreach($data['styles'] as $style) 
                                                    <option value="{{$style -> id}}"
                                                    {{$painting -> painting_style_category_id == $style -> id ? 'selected':''}}>{{$style -> name}} - {{$style -> id}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  name="painting_color_category_id" required>
                                                <option value="" disabled selected> Select a Color</option>
                                                @foreach($data['colors'] as $color)
                                                    <option value="{{$color -> id}}"
                                                    {{$painting -> painting_color_category_id == $color -> id ? 'selected':''}}>{{$color -> name}} - {{$color -> id}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"  name="painting_surface_category_id" required>
                                                <option value="" disabled selected> Select a Surface</option>
                                                @foreach($data['surfaces'] as $surface) 
                                                    <option value="{{$surface -> id}}" 
                                                    {{$painting -> painting_surface_category_id == $surface -> id ? 'selected' : ''}}>{{$surface -> name}} - {{$surface -> id}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="submit" name="edit-Painting" class="btn btn-primary btn-block">Save</button>
    ...
    ***********************************-->
    ...
    <!-- form validate -->
    <script>
        // no character allow in quantity, price, width, height
